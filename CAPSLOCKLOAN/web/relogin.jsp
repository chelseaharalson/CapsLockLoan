  ...
  <div id="footer" class="clear">
    ...
    <form action="Login" method="post">
        <table border="0">
            ...
            <tr><td>Username</td><td><input class="textbox" type="text" name="email"></td></tr>
            <tr><td>Password</td><td><input class="textbox" type="text" name="password"></td></tr>
        </table>
        <button class="btn btn-8 btn-8h">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Login &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
    </form>
